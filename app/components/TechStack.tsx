...
/* ─── 3-D Rotating Icon Cloud ──────────────────────────────────────────────── */
function IconCloud3D({ colorized }: { colorized: boolean }) {
      ...
      {TECHS.map((tech, i) => {
        ...
        return (
          <div
            ...
            onMouseEnter={() => setHoveredCloud(i)}
            onMouseLeave={() => setHoveredCloud(-1)}
          >
            <div
              style={{
                filter: isHov
            ...
            {isHov && (
              <div
                className="absolute -bottom-5 left-1/2 -translate-x-1/2 whitespace-nowrap
                           text-[10px] font-mono tracking-wide pointer-events-none"
                style={{ color: tech.color, opacity: 1 }}
              >
                {tech.label}
              </div>
            )}
      ...
      <div className="w-full">
        ...
        >
          ...
          <div className="flex flex-col items-center gap-4 sm:relative sm:flex-row sm:justify-center" style={{ maxWidth: gridW, margin: "0 auto" }}>
            ...
            {/* View toggle — mesh grid ↔ 3-D globe */}
            <div
              ...
              style={{
                borderColor: viewMode === "cloud"
                  ? "rgba(255,255,255,0.40)"
                  : viewBtnHover
                    ? "rgba(255,255,255,0.22)"
                    : "rgba(255,255,255,0.18)",
                background: viewMode === "cloud"
                  ? "rgba(255,255,255,0.10)"
                  : viewBtnHover
                    ? "rgba(255,255,255,0.04)"
                    : "transparent",
                color: viewMode === "cloud"
              ...
              <span className="relative flex items-center justify-center" style={{ width: 7, height: 7 }}>
                ...
                <span
                  style={{
                    ...
                    boxShadow: viewMode === "cloud" ? "0 0 6px 1px rgba(255,255,255,0.4)" : "none",
                  }}
                />
              </span>
        ...
        <div className="w-full overflow-x-auto px-3 sm:px-8">
          ...
          <div className="relative" style={{ width: gridW, height: gridH }}>
            ...
            <motion.div
              ...
              transition={{ duration: 0.35 }}
            >
              <IconCloud3D colorized={colorized} />
            </motion.div>
          )}
        </AnimatePresence>
